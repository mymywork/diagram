  ...
  joint.dia.Element.define('html.MyElement', {
    ...
    htmlMarkup: [{
      ...
      children: [{
        ...
        tagName: 'img',
        className: 'my-html-element-image',
        attributes: {
          'data-attribute': 'image',
          'src' : 'https://sun3-11.userapi.com/impg/2ImfeheG0cTbegpn_PgSMLcJeBGqBmdcraYanw/gGzmZfLSprY.jpg?size=100x0&quality=88&crop=79,60,403,403&sign=8ab485e225981993a754b6f25382540a&ava=1'
        }
      }]
    }]
  },{
